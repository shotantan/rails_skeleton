...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { description: @sensor.description, mac_address: @sensor.mac_address, name: @sensor.name }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { description: @sensor.description, mac_address: @sensor.mac_address, name: @sensor.name }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
